...
<form:form method="POST" modelAttribute="lecturer"
	...
	action="${pageContext.request.contextPath}/admin/managelecturers/edit/${lecturer.lecId}.html">

		<center>
    <h1>Edit a Lecturer's Detail</h1>
			<table cellpadding=4 cellspacing=2 border=0>
				...
				<tr>
				   ...
				   <td><form:input path="lecId" readonly="true"/></td>
			...
			<%-- 	 <td align="center">
				 <a href="${pageContext.request.contextPath}/admin/managelecturers/load" class="sidebar-button">
