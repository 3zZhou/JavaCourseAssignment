package sg.iss.wafflescollege.init;
...
@Configuration
@EnableWebMvc
@EnableTransactionManagement //for jpa
@ComponentScan(basePackages="sg.iss.wafflescollege")
@PropertySource({ "classpath:application.properties",
		"classpath:/i18n/messages.properties" })
@EnableJpaRepositories("sg.iss.wafflescollege.repo") //for query
