...
<form:form method="POST" modelAttribute="student"
	action="${pageContext.request.contextPath}/admin/managestudents/add">
		<center>
			...
			<table cellpadding=4 cellspacing=2 border=0>
				...
				<tr>
				 ...
				 <tr>
				   ...
				   <form:errors path="stuStatus" cssStyle="color: red;" />
				 </tr>
				 <tr>
