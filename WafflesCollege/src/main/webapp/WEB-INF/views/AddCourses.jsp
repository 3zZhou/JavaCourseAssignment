...
<form:form method="POST" modelAttribute="course"
	action="${pageContext.request.contextPath}/admin/managecourses/create">
		<center>
			...
			<table cellpadding=4 cellspacing=2 border=0>
				...
				<tr>
				   ...
				   <td><form:input path="cseId"/>
				   <form:errors path="cseId" cssStyle="color: red;" /></td>
				 </tr>
				 <tr>
				   <td><s:message code="Lecturer ID" /> *</td>
				   <td><form:input path="lecturer.lecId"/>
				   <form:errors path="lecturer.lecId" cssStyle="color: red;" /></td>
				 </tr>
				<tr>
				   <td><s:message code="Name of Course" /> *</td>
				   <td><form:input path="cseDesc"/>
				   <form:errors path="cseDesc" cssStyle="color: red;" /></td>
				 </tr>
				<tr>
				   <td><s:message code="Credits" /> *</td>
				   <td><form:input path="cseCredit"/>
				   <form:errors path="cseCredit" cssStyle="color: red;" /></td>
				 </tr>
<tr>
				   <td><s:message code="Maximum Class Size" /> *</td>
				   <td><form:input path="cseMaxSize"/>
				   <form:errors path="cseMaxSize" cssStyle="color: red;" /></td>
				 </tr>
				<tr>			
				   <td><s:message code="Course Start Date" /> </td>
				   <td><form:input type="date" path="cseStartdate"/>
				   <form:errors path="cseStartdate" cssStyle="color: red;" /></td>
				 </tr>
				<tr>
				   ...
				   <form:errors path="cseStatus" cssStyle="color: red;" /></td>
				 </tr>
				 <tr>
